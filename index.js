...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        ...
        gameCard.innerHTML = `
            ...
            <p>Pledges: $${games[i].pledged.toLocaleString()}<p>
...
const totalRaised = GAMES_JSON.reduce((sum, games) => sum + games.pledged, 0)
...
const unfundedString = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games.
Currently, ${totalUnfunded} ${totalUnfunded === 1 ? "game remains" : "games remain"} unfunded. We need your help to
